...
6. Atomic commits, push to public `rogerchappel/safecopy`, branch protection best effort.

## Boundaries

- Work only inside `/Users/roger/Developer/my-opensource/safecopy` unless reading shared tools/docs.
